...
export const mockDesignSystemItems = [
    // MOCK DATA: Components showcase
    {
        ...
        category: "buttons",
        icon: Component,
        description: "Main call-to-action button with hover states and loading support",
    ...
    },
    {
        ...
        category: "cards",
        icon: Component,
        description: "Product display card with image, title, price, and action buttons",
    ...
    },
    {
        ...
        category: "navigation",
        icon: Component,
        description: "Responsive navigation header with logo, menu, and user actions",
    ...
    },
    {
        ...
        category: "forms",
        icon: Component,
        description: "Standard form input with validation states and error messages",
    ...
    },
    {
        ...
        category: "overlays",
        icon: Component,
        description: "Accessible modal dialog with backdrop and keyboard navigation",
    ...
    // MOCK DATA: Snippets showcase
    {
        ...
        category: "tokens",
        icon: LayersIcon,
        description: "Complete color palette with primary, secondary, and neutral colors",
