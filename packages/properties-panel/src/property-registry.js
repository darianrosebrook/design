...
export class PropertyRegistry {
     ...
     */
    static getSectionsForNodeType(nodeType) {
        const allSections = this.getSections();
        // Filter sections based on node type compatibility
        return allSections.filter((section) => {
            return section.properties.some((prop) => this.isPropertyCompatibleWithNodeType(prop, nodeType));
        });
    }
    /**
     * Get properties for a specific node type
     */
    static getPropertiesForNodeType(nodeType) {
     ...
     */
    static isPropertyCompatibleWithNodeType(property, nodeType) {
