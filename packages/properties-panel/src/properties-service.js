 ...
 */
import { getNodeProperty, setNodeProperty, getApplicablePropertiesForNode, } from "./property-utils";
/**
...
export class PropertiesService {
    ...
    getMixedPropertyValue(propertyKey) {
        ...
        const allSame = values.every((value) => JSON.stringify(value) === JSON.stringify(firstValue));
    ...
    getSectionIdForProperty(propertyKey) {
        ...
        if (propertyKey.startsWith("frame.") ||
            propertyKey === "rotation" ||
            propertyKey === "constrainProportions") {
            return "layout";
        }
        if (propertyKey === "horizontalAlignment" ||
        ...
        if (propertyKey.startsWith("textStyle.") ||
