...
// Mock React since we're in a Node environment
global.React = {
  forwardRef: (fn) => fn,
  createElement: () => ({}),
};
...
async function testLibraryIngestion() {
  ...
  try {
    ...
    const {
      ...
      getIngestedComponents,
    } = require("./packages/design-editor/lib/utils/dynamic-component-registry.tsx");
    ...
    const allIngested = getIngestedComponents();
